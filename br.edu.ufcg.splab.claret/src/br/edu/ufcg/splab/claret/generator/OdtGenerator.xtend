...
import br.edu.ufcg.splab.claret.templating.Alnico
import br.edu.ufcg.splab.claret.templating.Context
...
class OdtGenerator {
  	def static generate(String systemName, Usecase usecase, IFileSystemAccess2 fsa) {
		...
		return Alnico.odtTransform(template, new Context(systemName, usecase))
  	}
}